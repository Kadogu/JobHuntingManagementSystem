	...
	%>
		...
		<div class="main">
			...
			<%	for(Company company : companies){	%>
					<tr>
						<td><input type="radio" form="edit" name="company" value="<%= company.getCompany_id() %>" id="<%= company.getCompany_id() %>"></td>
			...
			<form action="Company" method="post" id="edit">
				<input type="hidden" name="status" value="edit">
