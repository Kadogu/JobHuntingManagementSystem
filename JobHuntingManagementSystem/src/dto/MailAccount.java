 ...
 * {@code ACCOUNT_NAME - 送信者名(表示される名前)※アカウント名と異なっても大丈夫です。}<br>
 * {@code FOOTER - メールの最後に表示される文言}
 * */
public class MailAccount implements Serializable{
	...
	private static final String FOOTER = "このメールは盛岡情報ビジネス専門学校の生徒及び先生のためのものです。\n\n心当たりがない方はこのメールを削除して下さい。";
